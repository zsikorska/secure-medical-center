...
import {ToastMessageService} from "../toastr/toastr.service";
...
export class AccountService {
  ...
  constructor(private http: HttpClient, private toastService: ToastMessageService) {
  }
  ...
  logout() {
    ...
    this.toastService.info("You are logout");
  }
}
