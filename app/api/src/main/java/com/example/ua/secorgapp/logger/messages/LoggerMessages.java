...
public class LoggerMessages {
    /*
    Strings are used because we need to inject vulnerable strings
     */
    ...
    public static final String onAddPatientInfo(Patient patient) {
        return String.format("Add patient request - patientId: %s, email: %s, firstname: %s, lastname: %s, birthdate: %s, username: %s, password: %s",
                patient.getId(),
                patient.getEmail(),
